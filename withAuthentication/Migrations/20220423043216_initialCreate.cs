        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            /*  migrationBuilder.CreateTable(
                  ...
                  columns: table => new
                  {
                      ...
                      developerName = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
            ...
            /*
                        migrationBuilder.CreateTable(
                            ...
                            columns: table => new
                            {
                                ...
                                lastName = table.Column<string>(type: "varchar(15)", unicode: false, maxLength: 15, nullable: false),
                                phoneNumber = table.Column<string>(type: "char(10)", unicode: false, fixedLength: true, maxLength: 10, nullable: true),
            ...
            /*
                        migrationBuilder.CreateTable(
                            ...
                            columns: table => new
                            {
                                ...
                                lastName = table.Column<string>(type: "varchar(15)", unicode: false, maxLength: 15, nullable: false),
                                email = table.Column<string>(type: "varchar(25)", unicode: false, maxLength: 25, nullable: false),
                                companyName = table.Column<string>(type: "varchar(25)", unicode: false, maxLength: 25, nullable: false),
                                phoneNumber = table.Column<string>(type: "char(10)", unicode: false, fixedLength: true, maxLength: 10, nullable: true),
            ...
            /* migrationBuilder.CreateTable(
                 ...
                 constraints: table =>
                 {
                     table.PrimaryKey("PK__Develope__2ECD6E2437022F5B", x => x.reviewID);
                     table.ForeignKey(
            ...
            /*    migrationBuilder.CreateTable(
                    ...
                    constraints: table =>
                    {
                        table.PrimaryKey("PK__RealtorR__2ECD6E242A9243B3", x => x.reviewID);
                        table.ForeignKey(
                            name: "FK_realtorID",
